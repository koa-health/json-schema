...
public class ReferenceResolverTest {
    ...
    public void test(String testcaseName, String expectedOutput, String parentScope, String encounteredSegment) {
        String actual = org.everit.json.schema.loader.internal.ReferenceResolver.resolve(parentScope, encounteredSegment);
    ...
    public void testURI(String testcaseName, String expectedOutput, String parentScope, String encounteredSegment) {
        ...
        URI actual = org.everit.json.schema.loader.internal.ReferenceResolver.resolve(parentScopeURI, encounteredSegment);
    }

    @Test
    public void resolveWrapsURISyntaxException() {
        try {
            org.everit.json.schema.loader.internal.ReferenceResolver.resolve("\\\\somethin\010g invalid///", "segment");
