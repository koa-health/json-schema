...
public class EventToStringTest {
    ...
    private static final org.everit.json.schema.event.SchemaReferencedEvent REF_EVENT = new org.everit.json.schema.event.SchemaReferencedEvent(REF_SCHEMA, INSTANCE, REFERRED_SCHEMA, new ArrayList<>());

    @Test
    public void schemaReferenceEventToStringTest() {
        JSONObject expected = LOADER.readObj("reference-event.json");
        org.everit.json.schema.event.SchemaReferencedEvent subject = REF_EVENT;
    ...
    public void conditionalSchemaMatchEventToString_ifMatch() {
        ...
        org.everit.json.schema.event.ConditionalSchemaMatchEvent subject = new ConditionalSchemaMatchEvent(CONDITIONAL_SCHEMA, INSTANCE, IF);
    ...
    public void conditionalSchemaMismatchEvent() {
        ...
        org.everit.json.schema.event.ConditionalSchemaMismatchEvent subject = new ConditionalSchemaMismatchEvent(CONDITIONAL_SCHEMA, INSTANCE, IF, exc);
    ...
    public void combinedSchemaMatchEventToString() {
        ...
        org.everit.json.schema.event.CombinedSchemaMatchEvent subject = new CombinedSchemaMatchEvent(COMBINED_SCHEMA, TrueSchema.INSTANCE, INSTANCE, new ArrayList<>());
    ...
    public void combinedSchemaMismatchEventToString() {
        ...
        org.everit.json.schema.event.CombinedSchemaMismatchEvent subject = new CombinedSchemaMismatchEvent(COMBINED_SCHEMA, FalseSchema.INSTANCE, INSTANCE, exc, new ArrayList<>());
