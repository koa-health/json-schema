...
public class JsonObjectTest {
    ...
    private JsonObject subject() {
        return JsonValueTest.withLs(new JsonObject(storage())).requireObject();
    }
    ...
    public void idHandling() {
        ...
        URI actual = JsonValueTest.withLs(JsonValue.of(schema)).ls.id;
    ...
    public void nestedId() {
        ...
        URI actual = JsonValueTest.withLs(JsonValue.of(schema)).requireObject()
                .require("properties")
                .requireObject()
                .require("prop").ls.id;
    ...
    public void childForConsidersIdAttr() {
        ...
        JsonObject root = JsonValueTest.withLs(new JsonObject(toMap(input))).requireObject();
    ...
    public void idKeywordIsUsed() {
        ...
        JsonValue value = JsonValueTest.asV6Value(schema);
