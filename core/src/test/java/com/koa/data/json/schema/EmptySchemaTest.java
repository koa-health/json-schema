...
public class EmptySchemaTest {
    ...
    public void testValidate() {
        org.everit.json.schema.EmptySchema.INSTANCE.validate("something");
    }

    @Test
    public void testBuilder() {
        assertEquals(org.everit.json.schema.EmptySchema.builder().build(), org.everit.json.schema.EmptySchema.builder().build());
    }

    @Test
    public void testToString() {
        assertEquals("{}", org.everit.json.schema.EmptySchema.INSTANCE.toString());
    }

    private JSONObject json(final String title, final String description, final String id) {
        return new JSONObject(org.everit.json.schema.EmptySchema.builder().title(title).description(description).id(id)
                .build().toString());
    }
