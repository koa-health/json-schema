...
public class ToStringTest {
    ...
    static class CustomSchema extends org.everit.json.schema.Schema {

        static class CustomSchemaBuilder extends Builder<CustomSchema> {
        ...
        @Override void accept(org.everit.json.schema.Visitor visitor, List<String> path) {
    ...
    public void testBooleanSchema() {
        org.everit.json.schema.BooleanSchema subject = org.everit.json.schema.BooleanSchema.builder()
                .id("bool-id")
                .title("bool-title")
    ...
    public void testArraySchema() {
        org.everit.json.schema.ArraySchema subject = ArraySchema.builder()
                .uniqueItems(true)
    ...
    public void testFalseSchema() {
        ...
        new org.everit.json.schema.ToStringVisitor(writer).visit(INSTANCE);
    ...
    public void idKeywordForDraftV6() {
        org.everit.json.schema.Schema subject = org.everit.json.schema.ObjectSchema.builder()
                .addPropertySchema("a", ObjectSchema.builder()
                        .addPropertySchema("b", org.everit.json.schema.EmptySchema.builder()
    ...
    public void nonStringSchemaVersionIsIgnored() {
        org.everit.json.schema.Schema subject = org.everit.json.schema.EmptySchema.builder()
